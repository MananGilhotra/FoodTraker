      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Simulated map message moved above map container and centered */}
            <div className="mx-auto mt-6 max-w-xl bg-white/70 backdrop-blur-sm p-4 rounded-lg shadow-md text-center">
